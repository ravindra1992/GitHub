...
class Homepage : Fragment() {
    ...
    override fun onCreateView(
       ...
       val binding = FragmentHomepageBinding.inflate(inflater)
        ...
        val adapter = RecyclerViewAdapters(OnClickListener { viewModel.diplayUserDetails(it.users) /*Toast.makeText(context,
            "${it.users.events_url}", Toast.LENGTH_SHORT).show()*/})
